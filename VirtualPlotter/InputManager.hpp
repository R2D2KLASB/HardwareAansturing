...
* @brief Project_Game: The input manager is used to handle all kinds of input generated by the user of this application.
*/

/**
* @brief This class is used to handle input, generated by the user.
*/
class InputManager {
private:
...
public:
    ...
    /**
    * @brief This constructor constructs an object of the InputManager class.
    */
    InputManager();

    /**
    * @brief This function checks if a certain keyboard key is pressed.
    ...
    */
	...
	/**
    * @brief This function checks if a given mouse button is pressed.
    ...
    */
	...
	/**
    * @brief This function checks if a given sprite is clicked with a certain mouse button.
    * @details If the mouse button is clicked, it gets the cursor position on the given window, and checks if that position is inside the sprite boundaries or not.
    ...
    */
    ...
    /**
    * @brief This function checks if a given rectangle is clicked with a certain mouse button.
    * @details If the mouse button is clicked, it gets the cursor position on the given window, and checks if that position is inside the rectangle's boundaries or not.
    ...
    */
    ...
    /**
    * @brief This function checks if the current mouse position is inside a sprite.
    ...
    */
    ...
    /**
    * @brief This function changes the mouse cursor.
    * @details If the mouse is hovering over a sprite, it will change to a hand cursor, else it will turn into an arrow.
    ...
    */
    ...
    /**
    * @brief This function returns the mouse position on the given window.
